...
public class BankOffer extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        configureToolBar(Constants.SCREEN_TYPE_BANK_OFFER);

        if(ConnectivityUtils.isNetworkEnabled(this)){
            showProgressDialog(getString(R.string.progress_loading));
            new ApiRequestController(this, this).getData(Constants.REQUEST_GET_BANK_OFFER, null);
        }
        ...
        mListViewAllCategories.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(BankOffer.this, OfferDetailActivity.class);
